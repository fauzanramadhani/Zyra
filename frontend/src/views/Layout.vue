...
export default defineComponent({
  ...
  setup() {
    ...
    const navLinks = [
      ...
      { label: 'Gantt Chart', path: 'gantt', icon: GanttChartIcon },
      ...
      { label: 'Goals & OKR', path: 'goals', icon: TargetIcon },
      { label: 'Timesheet', path: 'timesheet', icon: TimerIcon },
      { label: 'Wiki', path: 'wiki', icon: BookOpenIcon },
      { label: 'Automation', path: 'automation', icon: ZapIcon },
      { label: 'Workflows', path: 'workflows', icon: WorkflowIcon },
      { label: 'Recurring Issues', path: 'recurring', icon: RepeatIcon },
      { label: 'SLA Policies', path: 'sla', icon: ClockIcon },
      { label: 'Approvals', path: 'approvals', icon: ShieldCheckIcon },
      { label: 'AI Assistant', path: 'ai', icon: SparklesIcon },
      { label: 'Git Integration', path: 'git', icon: GitBranchIcon },
      { label: 'Chat Integrations', path: 'chat-integrations', icon: MessageSquareIcon },
      { label: 'Email Webhook', path: 'email-inbox', icon: MailIcon },
      { label: 'Public Forms', path: 'forms', icon: ClipboardListIcon },
